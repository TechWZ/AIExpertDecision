...
public class OpenRouterController {
    ...
    @Operation(summary = "获取专家角色列表 (OpenRouter)", description = "基于OpenRouter API，根据研究内容和分析角度列表让大模型推荐5个专家角色")
    ...
    @Operation(summary = "获取专家角色列表和提示词 (OpenRouter)", description = "基于OpenRouter API，根据研究内容和分析角度列表让大模型推荐5个专家角色并生成对应的提示词")
    ...
    @Operation(summary = "生成专家提示词 (OpenRouter)", description = "基于OpenRouter API，根据决策需求和专家角色（每个角色包含其对应的分析角度）生成各专家角色的提示词")
    ...
    @Operation(summary = "执行分析决策 (OpenRouter)", description = "基于OpenRouter API，根据研究内容、专家角色和提示词生成各专家的分析决策和最终综合结论。支持包含现实专家的决策意见，现实专家的决策将原封不动返回，并在综合结论中被充分考虑。")
